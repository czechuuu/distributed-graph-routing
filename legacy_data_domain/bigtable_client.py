...
try:
    # When imported as a package: `import legacy_data_domain.bigtable_client`
    from .storage_types import bigtable_storage_pb2 as pb
except ImportError:
    # When run/imported from inside this directory: `import bigtable_client`
    from storage_types import bigtable_storage_pb2 as pb
